...
const CoverPage = () => {
  ...
  const history = useHistory();
    ...
    useEffect(() => {
      ...
      if (userInfo) {
        history.push("/chats"); // or navigate("/chats")
      }
    }, [history]);
      ...
      <div className="text-white text-2xl w-screen px-3">
        <div className="flex justify-between items-center h-10 md:w-1/2 mx-auto mt-3.5 flex-col md:flex-row">
          ...
          <nav className="flex flex-col md:flex-row space-between items-center text-lg md:text-2xl">
            {[
              { label: "Home", link: "/" },
              { label: "Features", link: "#features" }, // <-- this one can stay as <a>
        ...
        <div className="container" marginBottom="30px">
          <div className="row justify-content-md-center">
            <div className="col-12 col-md-10 col-lg-8 col-xl-7">
              ...
              <h2 className="display-5 mb-5 mb-xl-9 text-center md:text-3xl text-2xl">
                    ...
                    <div className="card border-0 bg-transparent">
                      ...
                      >
                        ...
                        <p
                          ...
                          style={{ fontSize: "1.2em" }}
                        >
                          Stay instantly updated with our real-time notification
                          system. Whenever you are online and someone sends you
                          a message, you’ll receive an immediate alert, ensuring
                          you never miss a conversation. Quick, reliable, and
                          designed to keep you engaged, it
