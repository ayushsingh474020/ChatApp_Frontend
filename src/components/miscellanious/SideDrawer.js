    ...
    <>
      ...
      >
        ...
        <h1 className="md:text-4xl text-xl text-white">
          Chat
          <span className="md:text-6xl text-2xl" style={{ color: "#3182CE" }}>
            App
          </span>{" "}
        </h1>
        ...
        <div>
          <Menu>
            ...
            {/* <MenuList bg="#3182CE" borderColor="gray.700">
            ...
            <MenuList bg="#3182CE" borderColor="gray.700">
              ...
              {notification.map((notif) => (
                <MenuItem
                  key={notif._id}
                  bg="#3182CE"
                  _hover={{ bg: "#3182CE" }} // keeps it same on hover
                  _active={{ bg: "#3182CE" }} // keeps it same on click
                  color="white"
                  onClick={() => {
                    setSelectedChat(notif.chat);
                    setNotification(notification.filter((n) => n !== notif));
          ...
          <Menu>
            ...
            <MenuList bg="gray.800" borderColor="gray.700">
              <ProfileModal user={user}>
                <MenuItem bg="gray.800" color="white">
                  My Profile
                </MenuItem>
              </ProfileModal>
              <MenuDivider />
              <MenuItem bg="gray.800" color="white" onClick={logoutHandler}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
